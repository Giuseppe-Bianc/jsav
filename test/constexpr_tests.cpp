...
TEST_CASE("binding_power: All relational operators have identical precedence", "[binding_power][operator][relational][T-BP-013]") {
    ...
    constexpr auto bp_greater = jsv::binding_power(greater);
    constexpr auto bp_geq = jsv::binding_power(geq);

    STATIC_REQUIRE(bp_less.first == bp_leq.first);
    STATIC_REQUIRE(bp_less.first == bp_greater.first);
    STATIC_REQUIRE(bp_less.first == bp_geq.first);
    STATIC_REQUIRE(bp_less.second == bp_leq.second);
    STATIC_REQUIRE(bp_less.second == bp_greater.second);
...
TEST_CASE("unary_binding_power: All unary operators have zero left binding power", "[unary_binding_power][invariant][T-UBP-006]") {
    ...
    constexpr auto ubp_preinc = jsv::unary_binding_power(preinc);
    constexpr auto ubp_predec = jsv::unary_binding_power(predec);

    STATIC_REQUIRE(ubp_minus.first == 0);
    STATIC_REQUIRE(ubp_minus.second > 0);
    STATIC_REQUIRE(ubp_not.first == 0);
    STATIC_REQUIRE(ubp_not.second > 0);
    STATIC_REQUIRE(ubp_preinc.first == 0);
    STATIC_REQUIRE(ubp_preinc.second > 0);
    STATIC_REQUIRE(ubp_predec.first == 0);
...
TEST_CASE("unary_binding_power: Precedence hierarchy among unary operators", "[unary_binding_power][hierarchy][T-UBP-007]") {
    ...
    STATIC_REQUIRE(ubp_not.second < ubp_minus.second);      // 21 < 22
    STATIC_REQUIRE(ubp_minus.second < ubp_preinc.second);   // 22 < 24
