...
// configuration step. It creates a namespace called `jsav`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", jsav::cmake::project_name, jsav::cmake::project_version) };
