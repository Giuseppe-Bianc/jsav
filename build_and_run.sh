...
cmake -S . -B ./build -Wno-dev -GNinja -Djsav_WARNINGS_AS_ERRORS=ON -Djsav_ENABLE_CLANG_TIDY:BOOL=ON -Djsav_ENABLE_IPO:BOOL=OFF -Djsav_PACKAGING_MAINTAINER_MODE=OFF || die "cmake configuration failed."
