...
- **FR-010**: Il sistema MUST supportare un sistema di tipi con tipi primitivi (integers, floats, bool), composti (array a dimensione fissa, struct con campi tipizzati, puntatori tipizzati) e definiti dall’utente, includendo regole di struttura, equivalenza e compatibilità operazionale.
