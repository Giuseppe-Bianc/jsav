...
**Module**: `jsv::unicode` (in `UnicodeData.hpp`, auto-generated via `scripts/generate_unicode_tables.py`)
**Date**: 2026-03-02
...
**Implementation note**: `UnicodeData.hpp` is generated by `scripts/generate_unicode_tables.py`.
This function must be added to the `generate_header()` template in that script, then the header
regenerated. Do NOT hand-edit `UnicodeData.hpp`.
